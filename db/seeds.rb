...
Country.create({ :continent_id => 1, :name => '朝鲜' })
...
Country.create({ :continent_id => 2, :name => '刚果共和国' })
Country.create({ :continent_id => 2, :name => '加纳' })
Country.create({ :continent_id => 2, :name => '纳米比亚' })
Country.create({ :continent_id => 2, :name => '塞舌尔' })
Country.create({ :continent_id => 2, :name => '马拉维' })
Country.create({ :continent_id => 2, :name => '厄立特里亚国' })
...
Country.create({ :continent_id => 3, :name => '阿尔巴尼亚' })
Country.create({ :continent_id => 3, :name => '马其顿' })
Country.create({ :continent_id => 3, :name => '塞浦路斯' })
...
Country.create({ :continent_id => 4, :name => '特立尼达和多巴哥' })
Country.create({ :continent_id => 5, :name => '澳大利亚' })
Country.create({ :continent_id => 5, :name => '新西兰' })
Country.create({ :continent_id => 5, :name => '斐济' })
Hotel.create({ :name => '北辰洲际酒店' }).rooms.create([{ :name => '行政大床房', :amount => 30 }, { :name => '观景大床房', :amount => 40 }, { :name => '观景双床房', :amount => 20 }, { :name => '豪华大床房', :amount => 120 }, { :name =>'豪华双床房', :amount => 20 }])
Hotel.create({ :name => '马哥孛罗酒店' }).rooms.create([{ :name => '标准间', :amount => 83 }, { :name => '大床间', :amount => 80 }])
Hotel.create({ :name => '五洲皇冠酒店' }).rooms.create([{ :name => '豪华大床房', :amount => 50 }, { :name => '高级大床房', :amount => 90 }, { :name => '高级双床房', :amount => 100 }])
Hotel.create({ :name => '国家会议中心酒店' }).rooms.create([{ :name => '标准间', :amount => 150 }])
Hotel.create({ :name => '中奥凯富' }).rooms.create([{ :name => '温馨套房（大床）', :amount => 70 }, { :name => '温馨套房（双床）', :amount => 10 }])
Hotel.create({ :name => '凯迪克酒店' }).rooms.create([{ :name => '标准间', :amount => 65 }, { :name => '大床房', :amount => 30 }])
Hotel.create({ :name => '喜来登酒店' }).rooms.create([{ :name => '豪华大床房', :amount => 120 }, { :name => '豪华双床房', :amount => 110 }])
Hotel.create({ :name => '西苑饭店' }).rooms.create([{ :name => '标准大床间', :amount => 50 }, { :name => '标准双床间', :amount => 70 }, { :name => '商务大床间', :amount => 50 }, { :name => '商务双床间', :amount => 50 }])