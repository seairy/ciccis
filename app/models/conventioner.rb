class Conventioner < ActiveRecord::Base
  ...
  scope :attend_consultation, where(:attend_consultation => true)
  scope :unattend_consultation, where(:attend_consultation => false)
  scope :unsure_attend_consultation, registered.where(:attend_consultation => nil)
  ...
  scope :attend_testcase, where(:attend_testcase => true)
  scope :unattend_testcase, where(:attend_testcase => false)
  scope :unsure_attend_testcase, registered.where(:attend_testcase => nil)
  ...
  scope :attend_president, where(:attend_president => true)
  scope :unattend_president, where(:attend_president => false)
  scope :unsure_attend_president, registered.where(:attend_president => nil)
