...
class StatisticsController < ApplicationController
  ...
  def general
    ...
    @attend_consultation_conventioners_count = Conventioner.attend_consultation.size
    @unattend_consultation_conventioners_count = Conventioner.unattend_consultation.size
    @unsure_attend_consultation_conventioners_count = Conventioner.unsure_attend_consultation.size
    ...
    @attend_testcase_conventioners_count = Conventioner.attend_testcase.size
    @unattend_testcase_conventioners_count = Conventioner.unattend_testcase.size
    @unsure_attend_testcase_conventioners_count = Conventioner.unsure_attend_testcase.size
    ...
    @attend_president_conventioners_count = Conventioner.attend_president.size
    @unattend_president_conventioners_count = Conventioner.unattend_president.size
    @unsure_attend_president_conventioners_count = Conventioner.unsure_attend_president.size
